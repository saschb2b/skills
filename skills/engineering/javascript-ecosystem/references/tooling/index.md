...
- [Package managers (pnpm / npm / Bun)](package-managers.md) - pnpm went security-by-default in v10 and shipped its Rust rewrite as v12 (Aug 2026); Bun 1.4 finished its own move to Rust and grew a built-in React Compiler and parallel test runner.
