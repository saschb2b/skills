...
- [transitions.md](./references/transitions.md) — the visual vocabulary, the frequency-as-budget rule, a per-case playbook (menu, pause, door, death, room-to-room), and the audio craft.
