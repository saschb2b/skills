...
- [Vercel AI SDK (`ai`)](vercel-ai-sdk.md) - v5 split messages into `UIMessage` (UI state, an ordered `parts` array) versus `ModelMessage` (LLM input). v7 made the SDK an agent platform and dropped the `experimental_` prefixes.
