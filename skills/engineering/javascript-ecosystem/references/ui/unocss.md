...
**Current stable**: 66.x (66.10, Sep 2026); a single rolling major across all packages. **LLM default bias**: the old `presetUno()` / `@unocss/preset-uno` paired with `@unocss/reset`, and framing UnoCSS as a Tailwind clone rather than an engine.
