...
**Verified 2026-08-20.** Check the installed `cypress` version first; re-verify if newer than below.

**Current stable**: 15.21 (Aug 2026; v15.0 GA Aug 2025). **LLM default bias**: Cypress 10 to 13, positioned as the leading or default e2e tool, with Cypress Cloud assumed necessary for parallelization.
...
| `cy.exec()` for shell work | `cy.task()` (`cy.exec()` is deprecated as of 15.21) |
