...
**Current stable**: v9.4 (Aug 2026). **LLM default bias**: v5, often v4. `makeStyles`/`withStyles`, the old `Grid` with `item`/`xs`/`md`, and Emotion theming as the assumed default.
