...
- [Nodemailer](nodemailer.md) - Nodemailer is still the canonical lower-level SMTP and transport library; the role is unchanged, but majors 7 through 10 broke on the edges, and v10 is a TypeScript rewrite with ESM and CJS builds.
