...
**Current stable**: 7.3 (Sep 2026); 7.0 shipped Jun 2026, 6.0 Mar 2026. **LLM default bias**: Astro 3 and 4. Legacy glob content collections, `output: 'hybrid'`, and no server islands or actions.
