...
- [Angular Material + CDK](angular-material.md) - Standalone components are the default (import the component class directly, no `MatXModule`).
- [Chakra UI](chakra.md) - v3 is a complete rewrite.
- [CSS-in-JS and styling status](css-in-js.md) - Runtime CSS-in-JS lost ground.
- [Headless UI primitives (Radix UI, Base UI, React Aria)](headless-ui.md) - The headless and primitive layer (unstyled, accessible behavior you style yourself) is the structural winner in React UI; shadcn/ui is copy-in components built on it.
