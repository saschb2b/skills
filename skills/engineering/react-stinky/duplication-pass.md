...
It produces findings under one category, `duplicate-implementation` (catalog category 44). Duplicated hook logic is category 30; duplicated JSX inside one file is category 36.
