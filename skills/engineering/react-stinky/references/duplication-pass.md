...
It produces findings under one category, `duplicate-implementation` (catalog category 56). Duplicated hook logic is category 34; duplicated JSX inside one file is category 42.
