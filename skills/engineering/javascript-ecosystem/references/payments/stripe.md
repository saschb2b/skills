...
| `apiVersion: '2022-11-15'` | The SDK's current pinned default (or `2026-07-29.dahlia`) |
...
- `@stripe/react-stripe-js` v6 deprecated `useCheckout()` in favor of `useCheckoutElements()`/`useCheckoutForm()`; it still works for now, with removal planned for v7.

## Companion
[polar.md](./polar.md) is the merchant-of-record alternative that takes worldwide tax off your plate.
